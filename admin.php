    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid mt-4">
                ...
                <embed src="html_backend/lietke.php" style="display: flex; width: 90%; height: 100%;">
                <embed src="backend_danhmuc/lietkedanhmuc.php" style="display: flex; width: 100%; height: 100%;">
                <embed src="backend_size/lietke.php" style="display: flex; width: 100%; height: 100%;">
                <embed src="backend_nhanvien/lietkenhanvien.php" style="display: flex; width: 100%; height: 100%;"> 
            </div>
        </div> -->
        <!-- /#page-content-wrapper
    </div>
