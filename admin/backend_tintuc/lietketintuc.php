                ...
                <form name="form" action="themtintuc.php" method="post" enctype="multipart/form-data">
                    <div class="container">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="tieude" class="form-control" name="tieude" required>
                        </div>
                        <div class="form-group">
                            <label for="noidung">Nội dung</label>
                            <textarea id="noidung" class="form-control" name="noidung" required></textarea>
                        </div>
                        <div class="form-group">
                            <label for="ngaytao">Ngày tạo</label>
                            <input type="date" id="ngaytao" class="form-control" name="ngaytao" required>
                        </div>
                        <div class="form-group">
