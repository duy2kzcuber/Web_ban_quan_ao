...
<form name="form" action="updatetintuc.php" method="post" enctype="multipart/form-data">
    ...
    <div class="container">
        ...
        <div class="form-group">
            ...
            <input type="text" id="tieude" class="form-control" name="tieude" value="<?php echo $row['tieude']; ?>">
        </div>
        <div class="form-group">
            <label for="noidung">Nội dung</label>
            <textarea id="noidung" class="form-control" name="noidung"><?php echo $row['noidung']; ?></textarea>
        </div>
        <div class="form-group">
